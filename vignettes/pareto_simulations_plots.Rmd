...
methods_list_pareto <- bind_rows( 
      ...
      tibble(method = "ccl"              , method_pretty = "CC-L"       , short = "CC-L" , color="#ddb310" ,  shrinkage="linear"), 
      ...
      tibble(method = "pareto_mle"       , method_pretty = "Pareto MLE" , short = "MR"   , color="#00bbad" ,  shrinkage="no shrinkage")
        ) %>%
...
pareto_eval_df <- bind_rows(pareto_res) %>% 
                         ...
                         summarize(MSE=mean(error), nmontecarlo=n()) %>%
